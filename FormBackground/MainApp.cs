    ...
    class MainApp : Form
    {
        ...
        void MainApp_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                Console.WriteLine($"[Color Change] ({oldColor.R}, {oldColor.G}, {oldColor.B}) => ({this.BackColor.R}, {this.BackColor.G}, {this.BackColor.B})");
            }
            else if (e.Button == MouseButtons.Right)
            {
                ...
                string file = "C:\\Users\\sim55\\Desktop\\sample.jpg"; 
